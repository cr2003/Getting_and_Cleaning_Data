...
## After decompressing the data you have the directory UCI HAR Dataset with the appropiate file structure
...
write.table(data_agg, "tidydata.txt", row.name = FALSE)
